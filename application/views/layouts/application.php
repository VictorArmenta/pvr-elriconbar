   ...
   <body>
    <div id="loadingimg"></div>
         ...
         <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown">
                    <a href="#" class="dropdown-toggle flat-box" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-bookmark"></i> <span class="menu-text"><?=label("Product");?> </span><span class="caret"></span></a>
                    <ul class="dropdown-menu">				  
				       <li class="flat-box"><a href="<?=base_url()?>products"><i class="fa fa-archive"></i> <span class="menu-text"><?=label("Product");?></span></a></li>
                       <li class="flat-box"><a href="<?=base_url()?>categories"><i class="fa fa-archive"></i> <span class="menu-text"><?=label("Categories");?></span></a></li> 
					   <li class="flat-box"><a href="<?=base_url()?>subcategories"><i class="fa fa-archive"></i> <span class="menu-text"><?=label("SubCategories");?></span></a></li> 
				    </ul>
                 </li> 
                 <li class="flat-box"><a href="<?=base_url()?>sales"><i class="fa fa-ticket"></i> <span class="menu-text"><?=label("Sales");?></span></a></li>
				 
				 <li class="dropdown">
                    <a href="#" class="dropdown-toggle flat-box" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-bookmark"></i> <span class="menu-text"><?=label("Expense");?> </span><span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      <li class="flat-box"><a href="<?=base_url()?>expences"><i class="fa fa-usd"></i> <span class="menu-text"><?=label("Expense");?></span></a></li>
				      <li class="flat-box"><a href="<?=base_url()?>categorie_expences"><i class="fa fa-usd"></i> <span class="menu-text"><?=label("Categories");?></span></a></li>
					  <li class="flat-box"><a href="<?=base_url()?>purchases"><i class="fa fa-shopping-cart"></i> <span class="menu-text"><?=label("Purchases");?></span></a></li>
				   </ul>
				 </li>    
                 ...
                 <?php } ?>
                 <li class="flat-box"><a href="<?=base_url()?>support"><i class="fa fa-comment"></i> <span class="menu-text"><?=label("Support");?></span></a></li>
               </ul>
               <ul class="nav navbar-nav navbar-right dropdown">
                  <li><a href="#" class="dropdown-toggle flat-box" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="hidden-xs"> &nbsp;&nbsp;<?php echo $this->user->firstname?> </span></a>
					 <ul class="dropdown-menu">				  
				       <li class="flat-box"><a href="perfil/editUserPass/<?=$this->user->id;?>" ><i class="fa fa-key"></i> <span class="menu-text"><?=label("ChangePassword");?></span></a></li>
				  ...
				  <?php if($this->user->role === "admin"){?><li><a href="https://www.prosoft-team.tech/" target='_blank'><i class='glyphicon glyphicon-envelope'></i></a></li><?php } ?>
                  <li><a href="https://www.prosoft-team.tech/" target='_blank'><i class='fa fa-question-circle fa-lg'></i></a></li>
      ...
      <script type="text/javascript" src="<?=base_url()?>assets/js/jquery.mousewheel.js"></script>
        ...
        <script src="<?=base_url()?>assets/js/jquery.keyboard.extension-typing.js"></script><!-- para lista de idiomas -->
  <script src="<?=base_url()?>assets/js/jquery.keyboard.extension-previewkeyset.js"></script><!-- para lista de idiomas -->

  <!-- preloaded keyboard layout -->
  <script src="<?=base_url()?>assets/js/keyboard-layouts-greywyvern.js" charset="utf-8"></script><!-- para lista de idiomas -->
  <script>
