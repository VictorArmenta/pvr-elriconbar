        ...
        foreach ($list as $expence) {
            ...
            if ($this->user->role === "admin")
                $row[] = '<div class="btn-group">
                      <a class="btn btn-danger" href="javascript:void(0)" onclick="delete_expences(' . $expence->id . ')" title="' . label("Delete") . '"><i class="fa fa-times"></i></a>
                      <a class="btn btn-primary" href="expences/edit/' . $expence->id . '" title="' . label("Edit") . '"><i class="fa fa-pencil"></i></a>
